<?php
    ...
    $sql = "UPDATE tb_biodatamhs SET
            nim ='$nim',Nama_Lengkap ='$Nama_Lengkap',Nama_Panggilan ='$Nama_Panggilan',Tanggal_Lahir ='$Tanggal_Lahir',Email ='$Email', Angkatan ='$Angkatan',Program_Studi ='$Program_Studi',Jenis_Kelamin ='$Jenis_Kelamin',Hobi ='$Hobi'
            WHERE nim ='$nim'";
    ...
    <h1 class="text-center mb-2">Form Biodata Mahasiswa</h1>
      ...
      <div class="form-group mb-3">
        ...
        <div class="form-group mb-3">
          ...
          <input type="text" name="nickname" id="nickname" placeholder="Nama Panggilan" class="form-control" value="<?php echo $row['Nama_Panggilan']; ?>">
        </div>
        <div class="form-group mb-3">
  ...
  <script>
    function validateForm() {
     ...
     // Validasi Nama Lengkap
      ...
      // Validasi Angkatan
      if (document.forms["formBiodata"]["angkatan"].value == "") {
